  ...
  _createClass(Link, [{
    ...
    value: function render() {
      ...
      return external ? _react2.default.createElement(
        'a',
        {
          className: (0, _classnames2.default)(classes.base, (_classNames = {}, _defineProperty(_classNames, classes.baseDefault, !footer && !tooltip), _defineProperty(_classNames, classes.baseFooter, footer), _defineProperty(_classNames, classes.baseTooltip, tooltip), _classNames)),
          target: '_blank',
        ...
        {
          className: (0, _classnames2.default)(classes.base, (_classNames2 = {}, _defineProperty(_classNames2, classes.baseDefault, !footer && !tooltip), _defineProperty(_classNames2, classes.baseFooter, footer), _defineProperty(_classNames2, classes.basetooltip, tooltip), _classNames2)),
          to: to,
          onClick: onClick
        },
        children
