...
var OtTableRF = function (_Component2) {
  _inherits(OtTableRF, _Component2);
  ...
  function OtTableRF() {
    ...
    _classCallCheck(this, OtTableRF);

    for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = OtTableRF.__proto__ || Object.getPrototypeOf(OtTableRF)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      page: 0,
      sortBy: _this2.props.sortBy,
      order: _this2.props.order
    }, _this2.handleChangePage = function (event, page) {
      var _this2$props = _this2.props,
          onPageSort = _this2$props.onPageSort,
      ...
      var _this2$props2 = _this2.props,
          reportTableSortEvent = _this2$props2.reportTableSortEvent,
          onPageSort = _this2$props2.onPageSort;
  ...
  _createClass(OtTableRF, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          headerGroups = _props2.headerGroups,
          tableRowComponent = _props2.tableRowComponent,
          serverSide = _props2.serverSide,
          totalRowsCount = _props2.totalRowsCount;
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _TableHead2.default,
                null,
                headerGroups ? _react2.default.createElement(
                  _TableRow2.default,
                  null,
                  headerGroups.map(function (g, i) {
                    return _react2.default.createElement(
                      _TableCell2.default,
                      {
                        colSpan: g.colspan,
                        key: i,
                        className: (0, _classnames2.default)(classes.tableCellHeader, classes.tableCellSpanHeader)
                      },
                      g.label
                    );
                  })
                ...
                _react2.default.createElement(
                  ...
                  columns.map(function (column) {
                    ...
                    return _react2.default.createElement(
                      ...
                      column.orderable !== false ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                data.slice().sort(getComparator(columns, sortBy, order)).slice((serverSide ? 0 : page) * pageSize, (serverSide ? 0 : page) * pageSize + pageSize).map(function (row, index) {
                  return _react2.default.createElement(
                    _TableRow2.default,
                    {
                      key: index,
...
exports.default = (0, _styles.withStyles)(tableStyles)(OtTableRF);